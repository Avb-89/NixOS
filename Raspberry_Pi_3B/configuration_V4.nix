...
#NOTE: for use it to use "nixos-rebuild switch -I nixpkgs=/root/airapkgs/"
#NOTE: Config it`s work! but have long time installed (2 days)
...
# Programms_and_Environment
    ...
    environment.systemPackages = with pkgs;
      [ wget vim htop mc screen git links2 stack ipfs-migrator robonomics_comm ];
...
# System_Settings
    networking.hostName = "Droid-01";
    time.timeZone = "Europe/Samara";


# Version
    system.nixos.stateVersion = "19.03";
# Users
